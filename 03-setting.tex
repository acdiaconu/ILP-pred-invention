...
\rolf{Just state in terms of clauses of a hypothesis, i.e.~exists clauses whose head predicate does not occur in BK (and is not the target).}
...
\begin{defn}[Reuse]
\rolf{Just state in terms of invented predicates of hypotheses.}
